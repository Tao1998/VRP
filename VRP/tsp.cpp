...
bool CTSP::CheckVaryAnt(CAnt ant)
{
    ...
    qDebug()<<"5665645454"<<" "<<dbL;

    if(g_CarAry[nCarNo-1].dbMaxLength==25.0)
    {
        qDebug()<<"救我"<<QString::number(dbL,'f', 2);
    }
    //========================================================
    return true;
...
bool CTSP::Vary()
{
    ...
    if (CheckVaryAnt(m_vary_ant) == true) //如果可行，复制过去
    {
        ...
        if(m_vary_ant.m_nPath[0]==23&&m_vary_ant.m_nPath[1]==4&&m_vary_ant.m_nPath[2]==3&&m_vary_ant.m_nPath[3]==17&&m_vary_ant.m_nPath[4]==11&&m_vary_ant.m_nPath[5]==20)
            qDebug()<<"Vary找到了";
        return true;
    }
...
bool CTSP::Vary_3()
{
    ...
    if (CheckVaryAnt(m_vary_ant) == true) //如果可行，复制过去
    {
        ...
        if(m_vary_ant.m_nPath[0]==23&&m_vary_ant.m_nPath[1]==4&&m_vary_ant.m_nPath[2]==3&&m_vary_ant.m_nPath[3]==17&&m_vary_ant.m_nPath[4]==11&&m_vary_ant.m_nPath[5]==20)
        {
            qDebug()<<"Vary_3找到了1"<<m_vary_ant.m_dbPathLength;
...
//    if(m_vary_ant.m_nPath[0]==23&&m_vary_ant.m_nPath[1]==4&&m_vary_ant.m_nPath[2]==3&&m_vary_ant.m_nPath[3]==17&&m_vary_ant.m_nPath[4]==11&&m_vary_ant.m_nPath[5]==20)
//    {
//        qDebug()<<"Vary_3找到了2"<<m_vary_ant.m_dbPathLength;
